// v1.3.1 Agent Lift: sandboxed email body renderer.
//
// Lifted verbatim from apps/agentic-inbox/app/components/EmailIframe.tsx
// (the agentic-inbox version itself is dependency-clean — only `dompurify`,
// which Parrot already has). Used by EmailPanel to render full HTML email
// bodies inside an opaque-origin iframe with DOMPurify sanitization +
// strict CSP, so an attacker who slips past DOMPurify still can't read
// cookies, mutate the parent DOM, or call the worker.
//
